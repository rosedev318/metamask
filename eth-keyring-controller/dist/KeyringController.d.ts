...
import type { Hex, Json, KeyringClass, Eip1024EncryptedData } from '@metamask/utils';
...
declare class KeyringController extends EventEmitter {
    ...
    store: ObservableStore<KeyringControllerPersistentState>;
     ...
     * @returns A Promise that resolves to the state.
     */
    addNewAccount(selectedKeyring: EthKeyring<Json>): Promise<KeyringControllerState>;
    /**
     * Export Account
     *
     ...
     */
    updateMemStoreKeyrings(): Promise<void>;
    /**
     * ===========================================
     ...
     */
    getEncryptionPublicKey(address: string, opts?: Record<string, unknown>): Promise<string>;
    /**
     * Decrypt Message
     *
     ...
     */
    prepareUserOperation(rawAddress: string, transactions: EthBaseTransaction[]): Promise<EthBaseUserOperation>;
    /**
     ...
     */
    patchUserOperation(rawAddress: string, userOp: EthUserOperation): Promise<EthUserOperationPatch>;
    /**
     ...
     */
    signUserOperation(rawAddress: string, userOp: EthUserOperation): Promise<string>;
    /**
     * =========================================
     ...
     */
    addNewKeyring(type: string, opts?: unknown): Promise<EthKeyring<Json>>;
    /**
     ...
     */
    getKeyringForAccount(address: string): Promise<EthKeyring<Json>>;
    /**
     * Restore Keyring
     *
     ...
     */
    restoreKeyring(serialized: SerializedKeyring): Promise<EthKeyring<Json> | undefined>;
    /**
     ...
     */
    unlockKeyrings(password: string | undefined, encryptionKey?: string, encryptionSalt?: string): Promise<EthKeyring<Json>[]>;
}
/**
