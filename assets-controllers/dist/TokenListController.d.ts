...
export declare type TokenListStateChange = ControllerStateChangeEvent<typeof name, TokenListState>;
export declare type TokenListControllerEvents = TokenListStateChange;
export declare type GetTokenListState = ControllerGetStateAction<typeof name, TokenListState>;
export declare type TokenListControllerActions = GetTokenListState;
...
export declare type TokenListControllerMessenger = RestrictedControllerMessenger<typeof name, TokenListControllerActions | AllowedActions, TokenListControllerEvents | AllowedEvents, AllowedActions['type'], AllowedEvents['type']>;
