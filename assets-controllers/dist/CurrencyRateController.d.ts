...
export declare type CurrencyRateStateChange = ControllerStateChangeEvent<typeof name, CurrencyRateState>;
export declare type CurrencyRateControllerEvents = CurrencyRateStateChange;
export declare type GetCurrencyRateState = ControllerGetStateAction<typeof name, CurrencyRateState>;
export declare type CurrencyRateControllerActions = GetCurrencyRateState;
declare type AllowedActions = NetworkControllerGetNetworkClientByIdAction;
declare type CurrencyRateMessenger = RestrictedControllerMessenger<typeof name, CurrencyRateControllerActions | AllowedActions, CurrencyRateControllerEvents, AllowedActions['type'], never>;
/**
