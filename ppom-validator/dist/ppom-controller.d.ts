...
import type { NetworkControllerStateChangeEvent, Provider } from '@metamask/network-controller';
...
export declare type PPOMControllerActions = UsePPOM;
export declare type PPOMControllerEvents = NetworkControllerStateChangeEvent;
export declare type PPOMControllerMessenger = RestrictedControllerMessenger<typeof controllerName, PPOMControllerActions, NetworkControllerStateChangeEvent, never, NetworkControllerStateChangeEvent['type']>;
