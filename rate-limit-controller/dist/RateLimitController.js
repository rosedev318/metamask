...
class RateLimitController extends base_controller_1.BaseControllerV2 {
    ...
    isRateLimited(api, origin) {
        var _a;
        const rateLimitCount = (_a = this.implementations[api].rateLimitCount) !== null && _a !== void 0 ? _a : this.rateLimitCount;
    ...
    recordRequest(api, origin) {
        var _a;
        const rateLimitTimeout = (_a = this.implementations[api].rateLimitTimeout) !== null && _a !== void 0 ? _a : this.rateLimitTimeout;
        this.update((state) => {
            var _a;
