 ...
 */
export declare type RateLimitState<RateLimitedApis extends Record<string, RateLimitedApi>> = {
 ...
 */
export declare class RateLimitController<RateLimitedApis extends Record<string, RateLimitedApi>> extends BaseController<typeof name, RateLimitState<RateLimitedApis>, RateLimitMessenger<RateLimitedApis>> {
