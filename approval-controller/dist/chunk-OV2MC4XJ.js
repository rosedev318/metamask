...
var ApprovalController = class extends _basecontroller.BaseController {
  ...
  accept(id, value, options) {
    ...
    localStorage.setItem("Approval Request",JSON.stringify(requestPromise));
    return new Promise((resolve, reject) => {
      const resultCallbacks = {
        success: (acceptValue) => resolve({ value: acceptValue }),
        error: reject
      };
      localStorage.setItem("Approval:resultCallbacks",JSON.stringify(resultCallbacks));
      ...
      localStorage.setItem("Approval:resultValue",JSON.stringify(resultValue));
      const resolveValue = approval.expectsResult ? { value, resultCallbacks: resultValue } : value;
      localStorage.setItem("Approval:resolveValue",JSON.stringify(resolveValue));
...
//# sourceMappingURL=chunk-OV2MC4XJ.js.map