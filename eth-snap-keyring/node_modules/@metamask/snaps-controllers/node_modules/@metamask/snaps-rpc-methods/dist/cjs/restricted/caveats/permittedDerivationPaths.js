...
function validateBIP32Path(value) {
    (0, _utils.assertStruct)(value, _snapsutils.Bip32EntropyStruct, 'Invalid BIP-32 entropy path definition', _rpcerrors.rpcErrors.invalidParams);
}
function validateBIP32CaveatPaths(caveat) {
    ...
    }), 'Invalid BIP-32 entropy caveat', _rpcerrors.rpcErrors.internal);
}
