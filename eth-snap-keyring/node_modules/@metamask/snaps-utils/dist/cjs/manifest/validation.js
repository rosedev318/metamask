...
_export(exports, {
    ...
    SnapAuxilaryFilesStruct: function() {
        return SnapAuxilaryFilesStruct;
    },
    InitialConnectionsStruct: function() {
        return InitialConnectionsStruct;
    },
...
const PermissionsStruct = (0, _superstruct.type)({
    ...
    snap_getLocale: (0, _superstruct.optional)((0, _superstruct.object)({})),
    wallet_snap: (0, _superstruct.optional)(SnapIdsStruct)
});
const SnapAuxilaryFilesStruct = (0, _superstruct.array)((0, _superstruct.string)());
const InitialConnectionsStruct = (0, _superstruct.record)((0, _superstruct.intersection)([
...
const SnapManifestStruct = (0, _superstruct.object)({
    ...
    proposedName: (0, _superstruct.size)((0, _superstruct.string)(), 1, 214),
    ...
    source: (0, _superstruct.object)({
        ...
        files: (0, _superstruct.optional)(SnapAuxilaryFilesStruct),
        locales: (0, _superstruct.optional)(SnapAuxilaryFilesStruct)
    }),
    initialConnections: (0, _superstruct.optional)(InitialConnectionsStruct),
