...
var _chunk7JPKNM2Xjs = require('./chunk-7JPKNM2X.js');


var _chunkWF3VLEGJjs = require('./chunk-WF3VLEGJ.js');
...
var _chunkOH6WM4Z6js = require('./chunk-OH6WM4Z6.js');


var _chunkB7GI5EWIjs = require('./chunk-B7GI5EWI.js');


var _chunkK6XMMCKJjs = require('./chunk-K6XMMCKJ.js');


var _chunkKQMYR73Xjs = require('./chunk-KQMYR73X.js');


var _chunkQVY5Q2VXjs = require('./chunk-QVY5Q2VX.js');
...
var UserOperationController = class extends _basecontroller.BaseController {
  ...
  constructor({
    ...
    _chunkZ4BLTVTBjs.__privateSet.call(void 0, this, _pendingUserOperationTracker, new (0, _chunkB7GI5EWIjs.PendingUserOperationTracker)({
  ...
  async addUserOperation(request, options) {
    _chunkOH6WM4Z6js.validateAddUserOperationRequest.call(void 0, request);
    _chunkOH6WM4Z6js.validateAddUserOperationOptions.call(void 0, options);
...
addUserOperation_fn = async function(request, options) {
  ...
  const smartContractAccount = requestSmartContractAccount ?? new (0, _chunkQVY5Q2VXjs.SnapSmartContractAccount)(this.messagingSystem);
  const cache = {
    chainId,
    metadata,
...
prepareUserOperation_fn = async function(cache) {
  ...
  _chunkOH6WM4Z6js.validatePrepareUserOperationResponse.call(void 0, response);
  const {
    bundler: bundlerUrl,
    callData,
  ...
  await _chunk7JPKNM2Xjs.updateGas.call(void 0, metadata, response, _chunkZ4BLTVTBjs.__privateGet.call(void 0, this, _entrypoint));
  _chunkZ4BLTVTBjs.__privateMethod.call(void 0, this, _updateMetadata, updateMetadata_fn).call(this, metadata);
};
...
addPaymasterData_fn = async function(metadata, smartContractAccount) {
  ...
  _chunkOH6WM4Z6js.validateUpdateUserOperationResponse.call(void 0, response);
...
signUserOperation_fn = async function(metadata, smartContractAccount) {
  ...
  _chunkOH6WM4Z6js.validateSignUserOperationResponse.call(void 0, response);
...
submitUserOperation_fn = async function(metadata) {
  ...
  const bundler = new (0, _chunkK6XMMCKJjs.Bundler)(metadata.bundlerUrl);
...
updateTransaction_fn = function(metadata) {
  ...
  const transactionMetadata = _chunkWF3VLEGJjs.getTransactionMetadata.call(void 0, metadata);
...
updateUserOperationAfterApproval_fn = async function(cache, updatedTransaction) {
  ...
  if (previousMaxFeePerGas !== updatedMaxFeePerGas || previousMaxPriorityFeePerGas !== updatedMaxPriorityFeePerGas) {
...
//# sourceMappingURL=chunk-W63SSGH2.js.map