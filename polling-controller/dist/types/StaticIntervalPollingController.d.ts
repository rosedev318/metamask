...
export declare const StaticIntervalPollingControllerOnly: (abstract new (...args: any[]) => {
    readonly "__#97117@#intervalIds": Record<PollingTokenSetId, NodeJS.Timeout>;
    "__#97117@#intervalLength": number | undefined;
    setIntervalLength(intervalLength: number): void;
    getIntervalLength(): number | undefined;
    _startPollingByNetworkClientId(networkClientId: NetworkClientId, options: Json): void;
    _stopPollingByPollingTokenSetId(key: PollingTokenSetId): void;
    readonly "__#97115@#pollingTokenSets": Map<`${string}:${string}`, Set<string>>;
