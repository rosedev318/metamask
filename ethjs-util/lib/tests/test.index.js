...
describe('check all exports', function () {
  ...
  it('valid getKeys should get keys from object in array', function () {
    ...
    assert.deepEqual(util.getKeys([{
      ...
      cool: 'fdsdfsfd'
    }], 'cool'), ['something', 'fdsdfsfd']);
    assert.deepEqual(util.getKeys([{
      type: '234424'
    }, {
      type: '243234242432'
    }], 'type'), ['234424', '243234242432']);
    assert.deepEqual(util.getKeys([{
      type: 'something'
    }, {
      type: 'something'
