...
})(DirectiveCommand = exports.DirectiveCommand || (exports.DirectiveCommand = {}));
...
function removeFencedCode(filePath, fileContent, featureLabels) {
    ...
    const parsedDirectives = matchedLines.map((matchArray) => {
        ...
        if (matchArray.index === undefined ||
            ...
            throw new Error(getInvalidFenceLineMessage(filePath, line !== null && line !== void 0 ? line : '', `Fence sentinel may only appear at the start of a line, optionally preceded by whitespace.`));
        }
